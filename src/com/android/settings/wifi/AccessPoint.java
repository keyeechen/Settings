...
class AccessPoint extends Preference {
    ...
    static final int SECURITY_WAPI_PSK = 3;
    static final int SECURITY_WAPI_CERT = 4;
    ...
    static int getSecurity(WifiConfiguration config) {
        ...
        if (config.wapiRootCert != null && config.wapiUserCert != null &&
                config.wapiRootCert.length() != 0 && config.wapiUserCert.length() != 0) {
