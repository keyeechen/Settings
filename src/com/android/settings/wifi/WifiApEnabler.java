...
public class WifiApEnabler {
    ...
    private boolean mAvoidSoftapOnOffToggle = false;
    ...
    public void setSoftapEnabled(boolean enable) {
        ...
        if (enable && ((wifiState == WifiManager.WIFI_STATE_ENABLING) ||
                    (wifiState == WifiManager.WIFI_STATE_ENABLED) || mAvoidSoftapOnOffToggle)) {
            if (mAvoidSoftapOnOffToggle) mAvoidSoftapOnOffToggle = false;
