...
public class WifiApDialog extends AlertDialog implements View.OnClickListener,
    ...
    public static final int WEP128_INDEX = 3;
    ...
    private int mChannelIndex = DEFAULT_CHANNEL_INDEX;
    ...
    public WifiApDialog(Context context, DialogInterface.OnClickListener listener,
        ...
        if (wifiConfig != null) {
            ...
            mChannelIndex = wifiConfig.wifiApChannelIndex;
        }
    }
    ...
    public static int getSecurityTypeIndex(WifiConfiguration wifiConfig) {
        if (wifiConfig.allowedKeyManagement.get(KeyMgmt.WPA_PSK)) {
            ...
            return WPA2_INDEX;
        } else if (wifiConfig.wepKeys[0] != null) {
            return WEP128_INDEX;
        }
        return OPEN_INDEX;
    }
    ...
    public WifiConfiguration getConfig() {
        ...
        config.wifiApChannelIndex = mChannelIndex;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner mChannel = ((Spinner) mView.findViewById(R.id.channel));
    ...
    private void validate() {
        ...
        if ((mSsid != null && mSsid.length() == 0) ||
                   (((mSecurityTypeIndex == WPA_INDEX) || (mSecurityTypeIndex == WPA2_INDEX))&&
                        mPassword.length() < 8) || (mSecurityTypeIndex == WEP128_INDEX && mPassword.length() != 13)) {
            getButton(BUTTON_SUBMIT).setEnabled(false);
        } else {
    ...
    private void showSecurityFields() {
        ...
        mHint = (TextView) mView.findViewById(R.id.hint);
        if (mSecurityTypeIndex == WEP128_INDEX) {
            mHint.setText("The password must have 13 characters.");
        } else {
            mHint.setText("The password must at least have 8 characters.");
        }
    }
}
