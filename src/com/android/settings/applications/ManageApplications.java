...
public class ManageApplications extends Fragment implements
    ...
    public static final int KILL_ALL_PROCESSES = MENU_OPTIONS_BASE + 9;
    public static final int KILL_ALL_SERVICES = MENU_OPTIONS_BASE + 10;
    // sort order
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.add(0, SHOW_BACKGROUND_PROCESSES, 3, R.string.show_background_processes)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
        menu.add(0, KILL_ALL_PROCESSES, 3, R.string.kill_all_processes)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
        menu.add(0, KILL_ALL_SERVICES, 3, R.string.kill_all_services)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
    ...
    void updateOptionsMenu() {
        ...
        if (mCurTab != null && mCurTab.mListType == LIST_TYPE_RUNNING) {
            ...
            mOptionsMenu.findItem(KILL_ALL_SERVICES).setVisible(showingBackground);
            mOptionsMenu.findItem(SHOW_BACKGROUND_PROCESSES).setVisible(!showingBackground);
            mOptionsMenu.findItem(KILL_ALL_PROCESSES).setVisible(!showingBackground);
            ...
            mOptionsMenu.findItem(KILL_ALL_SERVICES).setVisible(false);
            mOptionsMenu.findItem(KILL_ALL_PROCESSES).setVisible(false);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if ((menuId == SORT_ORDER_ALPHA) || (menuId == SORT_ORDER_SIZE)) {
            ...
            buildResetDialog();
        } else if (menuId == KILL_ALL_SERVICES) {
            if (mCurTab != null && mCurTab.mRunningProcessesView != null) {
                mCurTab.mRunningProcessesView.mAdapter.killBackground(false);
            }
        } else if (menuId == KILL_ALL_PROCESSES) {
            if (mCurTab != null && mCurTab.mRunningProcessesView != null) {
                mCurTab.mRunningProcessesView.mAdapter.killBackground(true);
            }
        } else {
