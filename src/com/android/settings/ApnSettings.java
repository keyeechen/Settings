...
public class ApnSettings extends PreferenceActivity implements
    ...
    public static final String PREFERRED_APN_URI2 =
    ...
    private static final Uri PREFERAPN_URI2 = Uri.parse(PREFERRED_APN_URI2);
    ...
    private final BroadcastReceiver mMobileStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(
                ...
                && intent.getSerializableExtra(PhoneConstants.SIM_ID_KEY) == mSimId) {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mSimId = (PhoneConstants.SimId)getIntent().getSerializableExtra(PhoneConstants.SIM_ID_KEY);
    ...
    private static boolean canHandleDefault(String type) {
        if (type == null || type.equals("")) {
            ...
            for (String t : types) {
                if (t.equals(PhoneConstants.APN_TYPE_DEFAULT) || t.equals(PhoneConstants.APN_TYPE_ALL)) {
                    return true;
                }
            }
        }
    ...
    private void fillList() {
        String where = "numeric=\""
            + android.os.SystemProperties.get(mIccOpertorNumeric, "")
            + "\"";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_RESTORE:
            new AlertDialog.Builder(this)
                    .setMessage(getResources().getString(R.string.menu_restore))
