...
public class ApnEditor extends PreferenceActivity
    ...
    private String mIccOpertorNumeric;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mSimId = (PhoneConstants.SimId)intent.getSerializableExtra(PhoneConstants.SIM_ID_KEY);
        if (PhoneConstants.SimId.SIM1 == mSimId) {
            if (Dsds.isDualSimSolution()) setTitle(getTitle() + ": " + getString(R.string.sim1));
            mIccOpertorNumeric = TelephonyProperties.PROPERTY_ICC_OPERATOR_NUMERIC;
            mCurrent = Telephony.Carriers.CURRENT;
        } else {
            if (Dsds.isDualSimSolution()) setTitle(getTitle() + ": " + getString(R.string.sim2));
            mIccOpertorNumeric = TelephonyProperties.PROPERTY_ICC_OPERATOR_NUMERIC2;
            mCurrent = Telephony.Carriers.CURRENT2;
        }
    ...
    private void fillUi() {
        if (mFirstTime) {
            ...
            if (mNewApn) {
                String numeric =
                    SystemProperties.get(mIccOpertorNumeric);
    ...
    private boolean validateAndSave(boolean force) {
        ...
        // avoid save if not change
        if (mNewApn || isContentChanged(values)){
    ...
    private Boolean isContentChanged(ContentValues values) {
         ...
         String  sval;
         try {
             if (  ((sval = (String)values.get(Telephony.Carriers.NAME)) != null) &&
                   (sval.equals(mCursor.getString(NAME_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.APN)) != null) &&
                   (sval.equals(mCursor.getString(APN_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.PROXY)) != null) &&
                   (sval.equals(mCursor.getString(PROXY_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.PORT)) != null) &&
                   (sval.equals(mCursor.getString(PORT_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.USER)) != null) &&
                   (sval.equals(mCursor.getString(USER_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.SERVER)) != null) &&
                   (sval.equals(mCursor.getString(SERVER_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.PASSWORD)) != null) &&
                   (sval.equals(mCursor.getString(PASSWORD_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.MMSPROXY)) != null) &&
                   (sval.equals(mCursor.getString(MMSPROXY_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.MMSPORT)) != null) &&
                   (sval.equals(mCursor.getString(MMSPORT_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.MMSC)) != null) &&
                   (sval.equals(mCursor.getString(MMSC_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.MCC)) != null) &&
                   (sval.equals(mCursor.getString(MCC_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.MNC)) != null) &&
                   (sval.equals(mCursor.getString(MNC_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.TYPE)) != null) &&
                   (sval.equals(mCursor.getString(TYPE_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.PROTOCOL)) != null) &&
                   (sval.equals(mCursor.getString(PROTOCOL_INDEX))) &&
                   (((val=values.getAsInteger(Telephony.Carriers.AUTH_TYPE))==null)
                    || val == mCursor.getInt(AUTH_TYPE_INDEX)) &&
                   (((val=values.getAsInteger(Telephony.Carriers.CURRENT))==null)
                    || val == mCursor.getInt(mCursor.getColumnIndexOrThrow(
                            Telephony.Carriers.CURRENT))) &&
                   ((sval = (String)values.get(Telephony.Carriers.ROAMING_PROTOCOL)) != null) &&
                   (sval.equals(mCursor.getString(ROAMING_PROTOCOL_INDEX))) &&
                   (((val=values.getAsInteger(Telephony.Carriers.BEARER)) == null)
                    || val == mCursor.getInt(BEARER_INDEX)) &&
                   ((sval = (String)values.get(Telephony.Carriers.MVNO_TYPE)) != null) &&
                   (sval.equals(mCursor.getString(MVNO_TYPE_INDEX))) &&
                   ((sval = (String)values.get(Telephony.Carriers.MVNO_MATCH_DATA)) != null) &&
                   (sval.equals(mCursor.getString(MVNO_MATCH_DATA_INDEX)))  ) {
                 //mCarrierEnabled checkbox is always disabled, ignore it
