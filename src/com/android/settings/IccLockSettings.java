 ...
 *
 */
public class IccLockSettings extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (TelephonyManager.getDefault().getSimStateDs(mSimId.ordinal()) != TelephonyManager.SIM_STATE_READY) {
            mPinDialog.setEnabled(false);
            mPinToggle.setEnabled(false);
        }

        mPhone = PhoneFactory.getPhone(mSimId);
    ...
    private void iccLockChanged(boolean success, int attemptsRemaining) {
        if (success) {
            ...
            Toast.makeText(getActivity(), getPinPasswordErrorMessage(attemptsRemaining), Toast.LENGTH_LONG)
                    .show();
        }
